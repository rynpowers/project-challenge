class DogsController < ApplicationController
  ...
  # GET /dogs.json
  def index
    @dogs = Dog.includes(:likes).paginate(page: params[:page], per_page: 5)
  ...
  def new
    ...
    if user_signed_in?
        ...
        flash[:alert] = "You must be signed in to create a dog"
  ...
  def edit
      if current_user == @dog.user
        ...
        flash[:alert] = "You must be the dog owner to do that"
